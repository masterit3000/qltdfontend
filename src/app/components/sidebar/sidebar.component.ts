...
export const ROUTES: RouteInfo[] = [
    // test cầm đồ
    { path: 'camdo', title: 'CẦM ĐỒ', icon: 'desktop_windows', class: '',sub:[] },
    // test vay lãi
    { path: 'vaylai', title: 'VAY LÃI', icon: 'desktop_windows', class: '',sub: [] },
        //test bát họ
    { path: 'batHo', title: 'BÁT HỌ ', icon: 'desktop_windows', class: '',sub: [] },
    //test khách hàng
